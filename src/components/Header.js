      ...
      return (
        <div className={'navBarWrapper'}>
          <nav className={'navbar navBarDefault m-auto rounded-none border-0 flex justify-between'}>
            ...
            {isSearchEnabled ? (
              <div className={'searchWrapper hidden-xs navBarUL p-0 relative w-auto '}>
                <Search collapse indices={searchIndices} />
              </div>
              ): null}
            <div id="navbar" className={'collapse navBarCollapse theme-accent-bg overflow-hidden sm:hidden md:block '}>
              <div className={'flex flex-col md:hidden overflow-scroll'}>
